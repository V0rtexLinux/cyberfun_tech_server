"""
================================================================================
Springbonnie'S SHOW PIZZARIA - Hardware Abstraction Layer
...
class HardwareController:
    ...
    def __init__(self, serial_port: str = None, baudrate: int = 115200):
        self.logger = logging.getLogger("Springbonnie.Hardware")
    ...
    def _init_default_config(self):
        """Inicializa configuração padrão de hardware do Springbonnie"""
        ...
        self.state.led_states["left_eye"] = (0, 100, 255)   # Azul Springbonnie
