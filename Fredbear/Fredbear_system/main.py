...
class CyberFunSystem:
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            from Fredbear_system.hal.hardware_controller import HardwareController
            ...
            from Fredbear_system.expression.facial_controller import FacialExpressionController
            ...
            from Fredbear_system.sensors.sensor_hub import SensorHub
            ...
            from Fredbear_system.sequences.animation_sequences import SequencePlayer
            ...
            from Fredbear_system.tts.tts_engine import TTSManager
            self.tts = TTSManager()
            ...
            if not self.args.no_ai:
                ...
                from Fredbear_system.ai.ai_brain import AIChatBrain
            ...
            from Fredbear_system.audio.show_orchestrator import ShowOrchestrator, EventType
            ...
            from Fredbear_system.kernel.fsm_kernel import FredbearKernel
            self.kernel = FredbearKernel()
            ...
            if not self.args.no_network:
                ...
                from Fredbear_system.network.ws_server import CyberFunWebServer
            ...
            # Animação de boot
            from Fredbear_system.sequences.animation_sequences import SequenceType
    ...
    def _on_presence_detected(self):
        ...
        from Fredbear_system.sequences.animation_sequences import SequenceType
        from Fredbear_system.expression.facial_controller import EmotionPreset
        from Fredbear_system.tts.tts_engine import TTSVoice
    ...
    def _register_show_callbacks(self):
        ...
        from Fredbear_system.audio.show_orchestrator import EventType
        from Fredbear_system.expression.facial_controller import EmotionPreset
    ...
    def _load_default_shows(self):
        ...
        shows_dir = "Fredbear_system/audio/shows"
