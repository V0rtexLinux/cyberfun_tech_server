...
class FredbearPersonality:
    """Define a personalidade e contexto do Fredbear."""

    SYSTEM_PROMPT_BASE = """Você é o Fredbear, o animatrônico principal da Cyber Fun Pizzaria.
...
class FallbackBrain:
    ...
    RESPONSES = {
        "padrão": [
            ...
            "Eu sou o Fredbear e eu aprovo essa mensagem! Ho ho ho!",
...
class AIChatBrain:
    """
    Cérebro de IA completo do Fredbear.
    ...
    def __init__(self, openai_key: str = None):
        ...
        self.personality = FredbearPersonality()
