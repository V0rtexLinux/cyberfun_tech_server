"""
================================================================================
SPRINGBONNIE'S SHOW PIZZARIA - Configuração Principal
================================================================================
Arquivo de configuração central para todo o sistema animatrônico.
Define parâmetros de hardware, comportamento, e personalidade do Springbonnie.
================================================================================
"""
...
class GeneralConfig:
    ...
    # Identificação
    robot_name: str = "Springbonnie"
    robot_version: str = "1.0.0"
    establishment_name: str = "Springbonnie's Show Pizzaria"
    ...
    log_level: str = "INFO"
    log_file: str = "/var/log/springbonnie.log"
...
class LEDHardwareConfig:
    ...
    default_color: Tuple[int, int, int] = (0, 100, 255)  # Azul Springbonnie
...
class AudioConfig:
    ...
    # Diretório de mídia
    media_directory: str = "/opt/springbonnie/media/"
...
class ShowConfig:
    ...
    timeline_directory: str = "/opt/springbonnie/timelines/"
...
class PersonalityConfig:
    """Configuração de personalidade do Springbonnie"""
    # Nome e backstory
    character_name: str = "Springbonnie"
    character_description: str = "O animatrônico original da Springbonnie's Family Diner"
    
    # Comportamento
    greeting_phrases: List[str] = field(default_factory=lambda: [
        "Olá, bem-vindo à Springbonnie's Show Pizzaria!",
...
@dataclass
class SpringbonnieConfig:
    """Configuração principal do sistema Springbonnie"""
    ...
    @classmethod
    def load_from_file(cls, filepath: str) -> 'SpringbonnieConfig':
...
DEFAULT_CONFIG = SpringbonnieConfig()


def get_config() -> SpringbonnieConfig:
    """Retorna a configuração atual do sistema"""
    return DEFAULT_CONFIG


def reload_config(config_path: str = None) -> SpringbonnieConfig:
    """Recarrega configuração de arquivo"""
    global DEFAULT_CONFIG
    
    if config_path and os.path.exists(config_path):
        DEFAULT_CONFIG = SpringbonnieConfig.load_from_file(config_path)
    else:
        DEFAULT_CONFIG = SpringbonnieConfig()
...
if __name__ == "__main__":
    config = SpringbonnieConfig()
    
    print("\n[SPRINGBONNIE CONFIG] Configuração padrão:")
    ...
    # Salvar exemplo
    config.save_to_file("springbonnie_config_example.json")
    print("\n[SPRINGBONNIE CONFIG] Exemplo salvo em springbonnie_config_example.json")