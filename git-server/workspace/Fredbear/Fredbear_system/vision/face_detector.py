"""
================================================================================
FREDBEAR'S SHOW PIZZARIA - Sistema de Visão Computacional
...
class LEDState:
    ...
    color: Tuple[int, int, int] = (0, 100, 255)  # BGR - Azul padrão Fredbear
...
class FaceDetectorTFLite:
    ...
    def __init__(self, model_path: str = "models/face_detection.tflite",
        ...
        self.logger = logging.getLogger("Fredbear.Vision")
        ...
        self.logger.info("[FREDBEAR VISION] Sistema de Visão inicializado")
...
class InteractionManager:
    ...
    def __init__(self, face_detector: FaceDetectorTFLite):
        ...
        self.logger = logging.getLogger("Fredbear.Interaction")
...
if __name__ == "__main__":
    ...
    print(f"\n[FREDBEAR VISION] Status: {detector.get_status()}")
    print(f"[FREDBEAR VISION] Rostos detectados: {len(faces)}")
