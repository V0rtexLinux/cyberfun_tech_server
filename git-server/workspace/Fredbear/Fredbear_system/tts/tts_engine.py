...
================================================================================
  O Fredbear pode literalmente falar usando qualquer um dos engines:
...
class TTSManager:
    """
    Gerenciador principal de Text-to-Speech do Fredbear.
    ...
    def __init__(self):
        ...
        # Frases pré-definidas do Fredbear
    ...
    def speak(self, text: str,
        ...
        """
        Principal função de fala do Fredbear.
